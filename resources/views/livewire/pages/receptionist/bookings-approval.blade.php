                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="inline-flex items-center bg-white/10 rounded-xl backdrop-blur-sm border border-white/20 text-xs font-medium overflow-hidden">
                        <button type="button"
                                ...
                                class="px-3 sm:px-4 py-2 {{ $activeTab === 'pending' ? 'bg-white text-gray-900' : 'text-white/80 hover:bg-white/10' }}">
                            Approval
                        </button>
                        <a href="{{ route('receptionist.bookinghistory') ?? '#' }}"
                           class="px-3 sm:px-4 py-2 text-white/80 hover:text-white hover:bg-white/10">
                           History
                        </a>
                    </div>
