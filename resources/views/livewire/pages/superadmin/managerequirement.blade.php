                        ...
                        <div class="flex items-start gap-3 flex-1">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="flex flex-wrap items-center gap-2 mt-2">
                                    <span class="{{ $chip }}"><span class="text-gray-500">Created:</span><span class="font-medium text-gray-700">{{ $req->created_at?->format('d M Y, H:i') }}</span></span>
                                    <span class="{{ $chip }}"><span class="text-gray-500">Updated:</span><span class="font-medium text-gray-700">{{ $req->updated_at?->format('d M Y, H:i') }}</span></span>
                                </div>
                            </div>
                        </div>
