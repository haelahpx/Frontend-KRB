<div class="bg-gray-50">
    ...
    <main class="px-4 sm:px-6 py-6 space-y-8">
                ...
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center backdrop-blur-sm border border-white/20">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.136a1.76 1.76 0 011.164-2.288l5.398-1.592a1.76 1.76 0 012.288 1.164l2.147 6.136a1.76 1.76 0 01-3.417-.592V5.882z" />
                        </svg>
                    </div>
                    <div>
            ...
            <form class="p-5" wire:submit.prevent="store">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" wire:model.defer="description" class="{{ $input }}" placeholder="e.g. Company wide meeting next Monday...">
        ...
        <div class="{{ $card }}">
            <div class="px-5 py-4 border-b border-gray-200">
                <div class="relative flex-1">
                    <input type="text" wire:model.live="search" placeholder="Search announcements..." class="{{ $input }} pl-10 w-full placeholder:text-gray-400">
            ...
            <div class="divide-y divide-gray-200">
                ...
                <div class="px-5 py-5 hover:bg-gray-50 transition-colors" wire:key="announcement-{{ $announcement->announcements_id }}">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="flex flex-wrap items-center gap-2 mt-2">
                                    ...
                                    <span class="{{ $chip }}">
                                        ...
                                        <span class="font-medium text-gray-700">{{ $announcement->formatted_created_date }}</span>
                                    </span>
                                </div>
                            </div>
                        </div>
        ...
        {{-- EDIT MODAL --}}
        @if($modalEdit)
        <div class="fixed inset-0 z-[60] flex items-center justify-center" role="dialog" aria-modal="true" wire:key="modal-edit-announcement" wire:keydown.escape.window="closeEdit">
