{{-- resources/views/livewire/pages/user/profile.blade.php --}}
{{-- Layout sudah di-handle oleh #[Layout('layouts.app')] di komponen Livewire --}}

{{-- (Opsional) Styling kecil untuk class "krbs-*" --}}
<style>
    .krbs-card {
        background: white;
