<div class="min-h-screen flex">
    ...
    <div class="flex-1 bg-white flex items-center justify-center px-8">
        <div class="w-full max-w-md">
            ...
            <!-- Register Form -->
            <form method="POST" action="" x-data="{ showPassword: false, showPasswordConfirmation: false }"
                class="space-y-6">
                @csrf
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="showPassword = !showPassword"
                            ...
                            <svg x-show="!showPassword"
                                class="h-5 w-5 transform hover:scale-110 transition-transform duration-200" fill="none"
                ...
                <div class="group">
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-3">Confirm
                        Password</label>
                    <div class="relative">
                        ...
                        <button type="button" @click="showPasswordConfirmation = !showPasswordConfirmation"
                            class="absolute inset-y-0 right-0 flex items-center text-gray-400 hover:text-gray-800 transition-colors duration-200">
                            <svg x-show="!showPasswordConfirmation"
                                class="h-5 w-5 transform hover:scale-110 transition-transform duration-200" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                ...
                <!-- Register Button -->
                <button type="submit"
                    class="w-full mt-8 rounded-4xl bg-black text-white py-4 px-6 font-medium tracking-wide hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 focus:ring-opacity-50 transform hover:scale-[1.02] transition-all duration-300">
                    CREATE ACCOUNT
                </button>

                <!-- Footer Links -->
                <div class="flex justify-center items-center mt-8 pt-6 border-t border-gray-100">
                    <a href=""
    ...
    <!-- Right side - Image -->
    <div class="flex-1 relative bg-center bg-cover bg-no-repeat"
