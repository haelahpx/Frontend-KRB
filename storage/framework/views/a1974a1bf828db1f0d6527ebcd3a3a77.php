                            ...
                            <div class="flex items-start gap-3 flex-1 min-w-0">
                                <div class="<?php echo e($icoAvatar); ?>">
                                    <!--[if BLOCK]><![endif]--><?php if($row->image): ?>
                                        ...
                                        >
                                    <?php else: ?>
                                        <?php echo e(strtoupper(substr(($row->item_name ?? 'D')[0] ?? 'D', 0, 1))); ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($row->receptionist?->full_name): ?>
                                            <span class="<?php echo e($chip); ?>">
                                                ...
                                                <span class="font-medium text-gray-700">Recp:
                                                    <?php echo e($row->receptionist->full_name); ?></span>
                                            </span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH C:\Users\Ochie\OneDrive\Documents\GitHub\Frontend-KRB\resources\views/livewire/pages/receptionist/docpackhistory.blade.php ENDPATH**/ ?>