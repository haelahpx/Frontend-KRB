    ...
    <div class="mx-auto max-w-7xl px-6 sm:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10 py-10">
            ...
            <div class="flex items-start">
                <img src="<?php echo e(asset('images/kebun-raya-bogor.png')); ?>" alt="Kebun Raya Bogor" class="h-20 w-auto">
            </div>
...
</footer><?php /**PATH C:\Users\Ochie\OneDrive\Documents\GitHub\Frontend-KRB\resources\views/livewire/components/partials/footer.blade.php ENDPATH**/ ?>