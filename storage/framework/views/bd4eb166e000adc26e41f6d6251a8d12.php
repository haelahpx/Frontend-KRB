        ...
        <section class="<?php echo e($card); ?>">
            <div class="px-5 py-4 border-b border-gray-200 flex items-center justify-between gap-3">
                ...
                <div class="flex items-center gap-3 w-full sm:w-auto">
                    <div class="w-40">
                        <select wire:model="filterType" class="<?php echo e($input); ?> h-10">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <select wire:model.defer="type" class="<?php echo e($input); ?>">
                            <option value="document">Document</option>
                            <option value="invoice">Invoice</option>
                            <option value="tel">Tel</option>
                        </select>
...
<?php endif; ?>
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex flex-wrap items-center gap-2">
                                        ...
                                        <span class="<?php echo e($chip); ?>">Type: <?php echo e(ucfirst($row->type)); ?></span>
...
<?php endif; ?>
                    ...
                    <form class="p-5 space-y-5" wire:submit.prevent="update">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                <label class="<?php echo e($label); ?>">Type</label>
                                <select wire:model.defer="edit_type" class="<?php echo e($input); ?>">
                                    <option value="document">Document</option>
                                    <option value="invoice">Invoice</option>
                                    <option value="tel">Tel</option>
                                </select>
...
</div><?php /**PATH /home/haelahpx/Documents/GitHub/Frontend-KRB/resources/views/livewire/pages/superadmin/documentsmanagement.blade.php ENDPATH**/ ?>