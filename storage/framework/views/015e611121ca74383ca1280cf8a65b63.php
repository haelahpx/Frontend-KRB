        ...
        <div class="<?php echo e($card); ?>">
            ...
            <form wire:submit.prevent="save" class="p-6 space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="<?php echo e($label); ?>">Hari / Tanggal</label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="<?php echo e($label); ?>">Nama Lengkap</label>
                        <input type="text" wire:model.defer="name" placeholder="Masukkan nama lengkap" class="<?php echo e($input); ?>">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        <label class="<?php echo e($label); ?>">Nomor HP</label>
                        <input type="text" wire:model.defer="phone_number" placeholder="08xxxxxxxxxx" class="<?php echo e($input); ?>">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="<?php echo e($label); ?>">Nama Instansi</label>
                        <input type="text" wire:model.defer="instansi" placeholder="Nama instansi/perusahaan" class="<?php echo e($input); ?>">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['instansi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-red-600 font-medium"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.defer="keperluan" placeholder="Tujuan kunjungan" class="<?php echo e($input); ?>">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['keperluan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-red-600 font-medium"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div>
                    <label class="<?php echo e($label); ?>">Nama Petugas Penjaga</label>
                    <input type="text" wire:model.defer="petugas_penjaga" placeholder="Nama petugas yang bertugas" class="<?php echo e($input); ?>">
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['petugas_penjaga'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-red-600 font-medium"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="pt-2 flex items-center gap-3">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(session('saved')): ?>
...
<?php /**PATH /home/haelahpx/Documents/GitHub/Frontend-KRB/resources/views/livewire/pages/receptionist/guestbook.blade.php ENDPATH**/ ?>