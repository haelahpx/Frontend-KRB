            ...
            <form class="p-5" wire:submit.prevent="store">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
                    ...
                    <div>
                        ...
                        <select class="<?php echo e($select); ?>" wire:model.defer="department_id">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $departmentOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="<?php echo e($card); ?>">
            <div class="px-5 py-4 border-b border-gray-200 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="relative">
                ...
                <div>
                    <select class="<?php echo e($select); ?>" wire:model.live="filter_department_id">
            ...
            <div class="divide-y divide-gray-200">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $information; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $rowNo = (($information->firstItem() ?? 1) + $loop->index); ?>
                    <div class="px-5 py-5 hover:bg-gray-50 transition-colors" wire:key="info-<?php echo e($info->information_id); ?>">
                        <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                            <div class="flex items-start gap-3 flex-1">
                                <div class="<?php echo e($ico); ?>"><?php echo e(substr(optional($info->company)->company_name ?? 'C', 0, 1)); ?>

                                </div>
                                <div class="min-w-0 flex-1">
                                    <h4 class="font-semibold text-gray-900 text-sm sm:text-base"><?php echo e($info->description); ?>

                                    </h4>

                                    <div class="flex flex-wrap items-center gap-2 mt-2">
                                        
                                        <!--[if BLOCK]><![endif]--><?php if($info->department): ?>
                                            <span class="<?php echo e($chip); ?>">
                                                ...
                                                <span class="font-medium text-gray-700">
                                                    <?php echo e($info->department->department_name); ?>

                                                </span>
                                            </span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                                        <!--[if BLOCK]><![endif]--><?php if($info->event_at): ?>
                                            <span class="<?php echo e($chip); ?>">
                                                <svg class="w-3.5 h-3.5 text-gray-500" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                ...
                                                <span class="font-medium text-gray-700"><?php echo e($info->formatted_event_date); ?></span>
                                            </span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <span class="<?php echo e($chip); ?>">
                                            ...
                                            <span
                                                class="font-medium text-gray-700"><?php echo e($info->formatted_created_date); ?></span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="text-right shrink-0 space-y-2">
                                ...
                                <div class="flex flex-wrap gap-2 justify-end pt-1">
                                    <button wire:click="openEdit(<?php echo e($info->information_id); ?>)" class="<?php echo e($btnBlk); ?>"
                                        wire:loading.attr="disabled" wire:target="openEdit(<?php echo e($info->information_id); ?>)"
                                        wire:key="btn-edit-info-<?php echo e($info->information_id); ?>">
                                        <span wire:loading.remove
                                            wire:target="openEdit(<?php echo e($info->information_id); ?>)">Edit</span>
                                        <span wire:loading
                                            wire:target="openEdit(<?php echo e($info->information_id); ?>)">Loading…</span>
                                    </button>

                                    <button wire:click="delete(<?php echo e($info->information_id); ?>)"
                                        ...
                                        wire:target="delete(<?php echo e($info->information_id); ?>)"
                                        wire:key="btn-del-info-<?php echo e($info->information_id); ?>">
                                        <span wire:loading.remove
                                            wire:target="delete(<?php echo e($info->information_id); ?>)">Delete</span>
                                        <span wire:loading
                                            wire:target="delete(<?php echo e($info->information_id); ?>)">Deleting…</span>
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <!--[if BLOCK]><![endif]--><?php if($information->hasPages()): ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                <label class="<?php echo e($label); ?>">Department</label>
                                <select class="<?php echo e($select); ?>" wire:model.defer="edit_department_id">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $departmentOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($opt['id']); ?>"><?php echo e($opt['name']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </select>
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['edit_department_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-rose-600 font-medium">
...
</div><?php /**PATH /home/haelahpx/Documents/GitHub/Frontend-KRB/resources/views/livewire/pages/superadmin/information.blade.php ENDPATH**/ ?>