            ...
            <form class="p-5" wire:submit.prevent="store">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="md:col-span-2">
                        <label class="<?php echo e($label); ?>">Nama Department</label>
                        <input type="text" class="<?php echo e($input); ?>" placeholder="e.g. Human Resource"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="<?php echo e($card); ?>">
            ...
            <div class="divide-y divide-gray-200">
                ...
                ?>
                <div class="px-5 py-5 hover:bg-gray-50 transition-colors" wire:key="dept-<?php echo e($r->department_id); ?>">
                    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">

                        
                        <div class="flex items-start gap-4 flex-1">
                            <div class="<?php echo e($ico); ?>"><?php echo e(strtoupper(substr($r->department_name, 0, 1))); ?></div>
                            <div class="min-w-0 flex-1 space-y-2">
                                <h4 class="font-semibold text-gray-900 text-sm sm:text-base truncate">
                                    <?php echo e($r->department_name); ?>
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <span class="<?php echo e($chip); ?>">
                                        ...
                                        <span class="font-medium text-gray-700"><?php echo e($r->created_at?->format('Y-m-d H:i')); ?></span>
                                    </span>
                                    <span class="<?php echo e($chip); ?>">
                                        <span class="text-gray-500">Updated:</span>
                                        <span class="font-medium text-gray-700"><?php echo e($r->updated_at?->format('Y-m-d H:i')); ?></span>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-right shrink-0 space-y-2">
                            <p class="<?php echo e($mono); ?>">No. <?php echo e($rowNo); ?></p> 
                            <div class="flex flex-wrap gap-2 justify-end">
                                <button
                                    class="<?php echo e($btnBlk); ?>"
                                    wire:click="openEdit(<?php echo e($r->department_id); ?>)"
                                    wire:loading.attr="disabled"
                                    wire:target="openEdit(<?php echo e($r->department_id); ?>)">
                                    <span wire:loading.remove wire:target="openEdit(<?php echo e($r->department_id); ?>)">Edit</span>
                                    <span wire:loading wire:target="openEdit(<?php echo e($r->department_id); ?>)">Loading…</span>
                                </button>

                                <button
                                    class="<?php echo e($btnRed); ?>"
                                    wire:click="delete(<?php echo e($r->department_id); ?>)"
                                    onclick="return confirm('Hapus department ini?')"
                                    wire:loading.attr="disabled"
                                    wire:target="delete(<?php echo e($r->department_id); ?>)">
                                    <span wire:loading.remove wire:target="delete(<?php echo e($r->department_id); ?>)">Hapus</span>
                                    <span wire:loading wire:target="delete(<?php echo e($r->department_id); ?>)">Menghapus…</span>
                                </button>
            ...
            <div class="relative w-full max-w-xl mx-4 <?php echo e($card); ?> focus:outline-none" tabindex="-1">
                ...
                <form class="p-5" wire:submit.prevent="update">
                    <div class="grid grid-cols-1 gap-5">
                        <div>
                            <label class="<?php echo e($label); ?>">Nama Department</label>
                            <input type="text" class="<?php echo e($input); ?>" wire:model.defer="edit_department_name" autofocus>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['edit_department_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-rose-600 font-medium"><?php echo e($message); ?></p> <?php unset($message);
...
</div><?php /**PATH /home/haelahpx/Documents/GitHub/Frontend-KRB/resources/views/livewire/pages/superadmin/department.blade.php ENDPATH**/ ?>