...
<?php endif; ?>
                    ...
                    <a href="<?php echo e(route('vehiclestatus')); ?>"
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-gray-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-3">
            <!--[if BLOCK]><![endif]--><?php if($mode === 'meeting'): ?>
                <div>
                    ...
                    <select wire:model.live="roomFilter"
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($r->room_id); ?>"><?php echo e($r->room_number); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </select>
                </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([$mode==='meeting' ? '' : 'md:col-span-2' ]); ?>">
                    ...
                    <div class="flex items-start justify-between gap-4 mb-2">
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-gray-900 truncate">
                                <?php echo e($b->meeting_title ?? 'Untitled'); ?>
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> <?php echo e($b->bookingroom_id); ?>

                                </span>

                                <!--[if BLOCK]><![endif]--><?php if($mode === 'meeting' && $b->room_id): ?>
...
<?php endif; ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($mode === 'online' && !empty($b->online_provider)): ?>
                                    <span class="text-gray-300">•</span>
                                    <span class="inline-flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium bg-gray-50 text-gray-700 border-2 border-gray-400">
                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                        <?php echo e(ucfirst($b->online_provider)); ?>
                        ...
                        <div class="flex items-center gap-2">
                            <span class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm font-medium <?php echo e($statusColor); ?>">
                                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!empty($b->special_notes)): ?>
                        <p class="text-sm text-gray-600 leading-relaxed">
                            <?php echo e($b->special_notes); ?>

                        </p>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                    <!--[if BLOCK]><![endif]--><?php if($b->status === 'rejected' && !empty($b->book_reject)): ?>
...
<?php endif; ?>
                            ...
                            <div class="mt-1 text-sm text-rose-800"><?php echo e($b->book_reject); ?></div>
                        </div>
                    <?php elseif(!empty($b->book_reject)): ?>
...
<?php endif; ?>
                            ...
                            <div class="mt-1 text-sm text-amber-800"><?php echo e($b->book_reject); ?></div>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                    <!--[if BLOCK]><![endif]--><?php if($mode === 'online'): ?>
                        <div class="mt-3 text-xs text-gray-600 space-y-1">
                            <!--[if BLOCK]><![endif]--><?php if(!empty($b->online_provider)): ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                    <span class="font-semibold">Provider:</span> <?php echo e(ucfirst($b->online_provider)); ?>

                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if(!empty($b->online_meeting_url)): ?>
...
<?php endif; ?>
                                    ...
                                    <a class="underline text-blue-600" href="<?php echo e($b->online_meeting_url); ?>" target="_blank" rel="noopener">Open link</a>
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if(!empty($b->online_meeting_code)): ?>
                                <div class="inline-flex items-center gap-1">
                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                    <span class="font-semibold">Code:</span> <?php echo e($b->online_meeting_code); ?>

                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if(!empty($b->online_meeting_password)): ?>
                                <div class="inline-flex items-center gap-1">
                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                    <span class="font-semibold">Password:</span> <?php echo e($b->online_meeting_password); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                        <span>Created: <?php echo e(optional($b->created_at)->format('Y-m-d H:i')); ?></span>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                        <span>Updated: <?php echo e(optional($b->updated_at)->format('Y-m-d H:i')); ?></span>
                    </div>
                </div>
        ...
        <!--[if BLOCK]><![endif]--><?php if(method_exists($bookings, 'links')): ?>
            <div class="mt-6">
...
<?php /**PATH /home/haelahpx/Documents/GitHub/Frontend-KRB/resources/views/livewire/pages/user/bookingstatus.blade.php ENDPATH**/ ?>