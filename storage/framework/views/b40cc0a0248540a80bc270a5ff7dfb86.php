                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-white/80">
                            Company:
                            <span class="font-semibold"><?php echo e(optional(Auth::user()->company)->company_name ?? '-'); ?></span>
                        </p>
                    </div>
                    <a href="<?php echo e(route('superadmin.managerequirements')); ?>" class="<?php echo e($btnLite); ?>">Go to Requirements</a>
                </div>
            </div>
        </div>
            ...
            <form class="p-5" wire:submit.prevent="roomStore">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['room_name'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        <label class="<?php echo e($label); ?>">Capacity (people)</label>
                        <input
                            type="number"
                            min="0"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="pt-5">
                    <button type="submit" wire:loading.attr="disabled" wire:target="roomStore"
                            class="<?php echo e($btnBlk); ?> relative overflow-hidden">
            ...
            <div class="divide-y divide-gray-200">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <div class="px-5 py-5 hover:bg-gray-50 transition-colors" wire:key="room-<?php echo e($room->room_id); ?>">
                        <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                            <div class="flex items-start gap-3 flex-1">
                                <div class="<?php echo e($ico); ?>">
                                    <?php echo e(substr(optional(Auth::user()->company)->company_name ?? 'C', 0, 1)); ?>

                                </div>
                                <div class="min-w-0 flex-1">
                                    <h4 class="font-semibold text-gray-900 text-sm sm:text-base">
                                        Room <?php echo e($room->room_name); ?>

                                    </h4>
                                    <div class="flex flex-wrap items-center gap-2 mt-2">
                                        <span class="<?php echo e($chip); ?>">
                                            <span class="text-gray-500">Created:</span>
                                            <span class="font-medium text-gray-700"><?php echo e($room->created_at?->format('d M Y, H:i')); ?></span>
                                        </span>
                                        <span class="<?php echo e($chip); ?>">
                                            <span class="text-gray-500">Updated:</span>
                                            <span class="font-medium text-gray-700"><?php echo e($room->updated_at?->format('d M Y, H:i')); ?></span>
                                        </span>
                                        <span class="<?php echo e($chip); ?>">
                                            <span class="text-gray-500">Capacity:</span>
                                            <span class="font-medium text-gray-700"><?php echo e($room->capacity ?? '—'); ?></span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="text-right shrink-0 space-y-2">
                                ...
                                <div class="flex flex-wrap gap-2 justify-end pt-1">
                                    <button
                                        wire:click="roomOpenEdit(<?php echo e($room->room_id); ?>)"
                                        class="<?php echo e($btnBlk); ?>"
                                        wire:loading.attr="disabled"
                                        wire:target="roomOpenEdit(<?php echo e($room->room_id); ?>)"
                                        wire:key="btn-edit-room-<?php echo e($room->room_id); ?>">
                                        <span wire:loading.remove wire:target="roomOpenEdit(<?php echo e($room->room_id); ?>)">Edit</span>
                                        <span wire:loading wire:target="roomOpenEdit(<?php echo e($room->room_id); ?>)">Loading…</span>
                                    </button>

                                    <button
                                        wire:click="roomDelete(<?php echo e($room->room_id); ?>)"
                                        onclick="return confirm('Hapus room ini?')"
                                        class="<?php echo e($btnRed); ?>"
                                        wire:loading.attr="disabled"
                                        wire:target="roomDelete(<?php echo e($room->room_id); ?>)"
                                        wire:key="btn-del-room-<?php echo e($room->room_id); ?>">
                                        <span wire:loading.remove wire:target="roomDelete(<?php echo e($room->room_id); ?>)">Delete</span>
                                        <span wire:loading wire:target="roomDelete(<?php echo e($room->room_id); ?>)">Deleting…</span>
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <!--[if BLOCK]><![endif]--><?php if($roomModal): ?>
                ...
                <div class="relative w-full max-w-xl mx-4 <?php echo e($card); ?> focus:outline-none" tabindex="-1">
                    ...
                    <form class="p-5" wire:submit.prevent="roomUpdate">
                        <div class="space-y-5">
                            <div>
                                <label class="<?php echo e($label); ?>">Room Name</label>
                                <input type="text" class="<?php echo e($input); ?>" wire:model.defer="room_edit_name" autofocus>
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['room_edit_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                <label class="<?php echo e($label); ?>">Capacity (people)</label>
                                <input type="number" min="0" class="<?php echo e($input); ?>" wire:model.defer="room_edit_capacity">
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['room_edit_capacity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="mt-6 flex items-center justify-end gap-3 border-t border-gray-200 pt-4">
                            <button type="button" class="<?php echo e($btnLite); ?>" wire:click="roomCloseEdit">Cancel</button>
                            <button type="submit" wire:loading.attr="disabled" wire:target="roomUpdate" class="<?php echo e($btnBlk); ?>">
...
<?php /**PATH /home/haelahpx/Documents/GitHub/Frontend-KRB/resources/views/livewire/pages/superadmin/manageroom.blade.php ENDPATH**/ ?>