        ...
        <div class="flex items-center justify-start gap-3">
            ...
            <div class="ml-auto inline-flex rounded-md overflow-hidden bg-gray-100 border border-gray-200">
                <a href="<?php echo e(route('create-ticket')); ?>"
                    class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'px-4 py-2 text-sm font-medium transition-colors inline-flex items-center' , 'bg-gray-900 text-white'=> $isCreate,
                    'text-gray-700 hover:text-gray-900' => !$isCreate,
                    ]); ?>">
                    Create Ticket
                </a>
                <a href="<?php echo e(route('ticketstatus')); ?>"
                    class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'px-4 py-2 text-sm font-medium transition-colors border-l border-gray-200 inline-flex items-center' , 'bg-gray-900 text-white'=> $isStatus,
    ...
    <div class="bg-white rounded-xl border-2 border-black/80 shadow-md p-4">
        ...
        <div class="space-y-5">
            ...
            <div class="relative bg-white rounded-xl border-2 border-black/80 shadow-md p-6 hover:shadow-lg hover:-translate-y-0.5 transition">
                <a href="<?php echo e(route('user.ticket.show', $t)); ?>" class="absolute inset-0 z-20" aria-label="Open ticket #<?php echo e($t->ticket_id); ?>"></a>
...
<?php endif; ?> <?php echo e($t->ticket_id); ?>
                            ...
                            ?>
                            <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'inline-flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium' , 'bg-orange-50 text-orange-700 border-2 border-orange-400'=> $isHigh,
...
<?php endif; ?>
                            ...
                            <span class="text-gray-300">•</span>
                            <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'inline-flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium' , 'border-2' ,
...
<?php endif; ?>
                    ...
                    <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm font-medium' , 'bg-yellow-50 text-yellow-700 border-2 border-yellow-500'=> $isOpen,
...
<?php endif; ?>
                ...
                <div class="mt-4 flex flex-col sm:flex-row sm:items-center justify-end gap-2 relative z-30 pointer-events-auto">
                    ...
                    <button
                        ...
                        class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2' ,
                        $hasAgent
...
</div><?php /**PATH C:\Users\Ochie\OneDrive\Documents\GitHub\Frontend-KRB\resources\views/livewire/pages/user/ticketstatus.blade.php ENDPATH**/ ?>