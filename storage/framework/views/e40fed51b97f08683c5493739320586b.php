                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $requirementsMaster; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reqName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <label class="flex items-center space-x-2">
                                        <input type="checkbox" wire:model.live="requirements" value="<?php echo e($reqName); ?>"
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-600">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if(!empty($booking['requestinformation'])): ?>
                                            <span class="ml-2 text-xs text-gray-500">• Info: <?php echo e(ucfirst($booking['requestinformation'])); ?></span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </p>
                                </div>
                            </div>
            ...
            <div class="bg-gray-50 border-b-2 border-black p-4 md:p-6">
                ...
                <div class="mt-4 flex items-center justify-between">
                    ...
                    <div class="flex gap-2">
                        <button wire:click="prevRoomPage" class="px-3 py-1.5 border border-gray-300 rounded-md text-sm hover:bg-gray-50 disabled:opacity-50" <?php echo e($roomsPage <= 1 ? 'disabled' : ''); ?>>‹ Rooms</button>
                        <button wire:click="nextRoomPage" class="px-3 py-1.5 border border-gray-300 rounded-md text-sm hover:bg-gray-50 disabled:opacity-50" <?php echo e($roomsPage >= $roomsTotalPages ? 'disabled' : ''); ?>>Rooms ›</button>
                    </div>
                </div>
            </div>
                ...
                <div class="flex">
                    <div class="w-20 shrink-0 border-r border-gray-200 bg-gray-50 sticky left-0 z-10">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="h-7 md:h-8 text-[10px] md:text-xs text-gray-600 flex items-center justify-center border-b border-gray-100"><?php echo e($t); ?></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <div class="min-w-[640px]">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="grid border-b border-gray-100" style="grid-template-columns: repeat(<?php echo e(count($visibleRooms)); ?>, minmax(160px,1fr));">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $visibleRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3225722762-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /home/adomancer/Documents/GitHub/KRB-System/resources/views/livewire/pages/user/bookroom.blade.php ENDPATH**/ ?>