            ...
            <form class="p-5" wire:submit.prevent="create">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        ...
                        <input type="text" wire:model.defer="name" class="<?php echo e($input); ?>" placeholder="e.g. Avanza">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        <label class="<?php echo e($label); ?>">Category</label>
                        <input type="text" wire:model.defer="category" class="<?php echo e($input); ?>"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        <label class="<?php echo e($label); ?>">Plate Number</label>
                        <input type="text" wire:model.defer="plate_number" class="<?php echo e($input); ?>"
                            placeholder="e.g. B 1234 ABC">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['plate_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-rose-600 font-medium"><?php echo e($message); ?></p>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        <label class="<?php echo e($label); ?>">Year</label>
                        <input type="text" wire:model.defer="year" class="<?php echo e($input); ?>" placeholder="e.g. 2023">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.defer="notes" class="<?php echo e($input); ?>" placeholder="Optional notes">
                    </div>
...
<?php endif; ?>
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex flex-wrap items-center gap-2">
                                        ...
                                        <span class="<?php echo e($mono); ?>"><?php echo e($row->plate_number); ?></span>
                                    ...
                                    <div class="flex flex-wrap gap-2 mt-2">
                                        <span class="<?php echo e($chip); ?>">Category: <?php echo e($row->category); ?></span>
                                        <span class="<?php echo e($chip); ?>">Year: <?php echo e($row->year); ?></span>
                                ...
                                <div class="flex flex-wrap gap-2 justify-end">
                                    <!--[if BLOCK]><![endif]--><?php if(!$row->deleted_at): ?>
                                        <button class="<?php echo e($btnLite); ?>"
                                            wire:click="openEdit(<?php echo e($row->vehicle_id); ?>)">Edit</button>
                                        <button class="<?php echo e($btnRed); ?>" wire:click="delete(<?php echo e($row->vehicle_id); ?>)"
                                            onclick="return confirm('Move to trash?')">Delete</button>
                                    <?php else: ?>
                                        <button class="<?php echo e($btnLite); ?>"
                                            wire:click="restore(<?php echo e($row->vehicle_id); ?>)">Restore</button>
                                        <button class="<?php echo e($btnRed); ?>" wire:click="forceDelete(<?php echo e($row->vehicle_id); ?>)"
...
<?php endif; ?>
                    ...
                    <form class="p-5 space-y-5" wire:submit.prevent="update">
                        ...
                        <div>
                            <label class="<?php echo e($label); ?>">Category</label>
                            <input type="text" wire:model.defer="edit_category" class="<?php echo e($input); ?>">
                        </div>
                        <div>
                            <label class="<?php echo e($label); ?>">Plate Number</label>
                            <input type="text" wire:model.defer="edit_plate_number" class="<?php echo e($input); ?>">
                        </div>
                        <div>
                            <label class="<?php echo e($label); ?>">Year</label>
                            <input type="text" wire:model.defer="edit_year" class="<?php echo e($input); ?>">
                        </div>
                        <div>
                            <label class="<?php echo e($label); ?>">Notes</label>
                            <input type="text" wire:model.defer="edit_notes" class="<?php echo e($input); ?>">
                        </div>
...
</div><?php /**PATH /home/haelahpx/Documents/GitHub/Frontend-KRB/resources/views/livewire/pages/superadmin/vehicle.blade.php ENDPATH**/ ?>