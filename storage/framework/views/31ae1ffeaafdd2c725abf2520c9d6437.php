                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-white/80">
                            Mengelola user untuk perusahaan: <span class="font-semibold"><?php echo e($company_name); ?></span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form class="p-5" wire:submit.prevent="store">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" class="<?php echo e($input); ?>" wire:model.defer="full_name" placeholder="e.g. John Doe">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <input type="email" class="<?php echo e($input); ?>" wire:model.defer="email" placeholder="e.g. john@company.com">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <input type="text" class="<?php echo e($input); ?>" wire:model.defer="phone_number" placeholder="08123456789">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <input type="password" class="<?php echo e($input); ?>" wire:model.defer="password" autocomplete="new-password">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <input type="text" class="<?php echo e($input); ?>" value="<?php echo e($company_name); ?>" readonly>
                    </div>

                    
                    <div>
                        <label class="<?php echo e($label); ?>">Role</label>
                        <select class="<?php echo e($input); ?>" wire:model.live="role_id">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($role_id == $roleReceptionistId || $role_id == $roleSuperadminId): ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($role_id == $roleReceptionistId || $role_id == $roleSuperadminId): ?>
                            <input type="text" value="Tidak diperlukan untuk peran ini" disabled
                                class="<?php echo e($input); ?> bg-gray-100 text-gray-500 border-gray-200 cursor-not-allowed">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="<?php echo e($card); ?>">
            ...
            <div class="divide-y divide-gray-200">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $rowNo = (($users->firstItem() ?? 1) - 0) + $loop->index; ?>
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="<?php echo e($chip); ?>">
                                            ...
                                            <span class="font-medium text-gray-700"><?php echo e($u->department->department_name ?? 'N/A'); ?></span>
                                        </span>
                                    </div>
        ...
        <!--[if BLOCK]><![endif]--><?php if($modalEdit): ?>
            <div class="fixed inset-0 z-[60] flex items-center justify-center" wire:keydown.escape.window="closeEdit">
                ...
                <div class="relative w-full max-w-2xl mx-4 <?php echo e($card); ?>">
                    ...
                    <form class="p-5" wire:submit.prevent="update">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                <label class="<?php echo e($label); ?>">Full Name</label>
                                <input type="text" class="<?php echo e($input); ?>" wire:model.defer="edit_full_name">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <input type="password" class="<?php echo e($input); ?>" wire:model.defer="edit_password" autocomplete="new-password">
                            </div>
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($edit_role_id == $roleReceptionistId || $edit_role_id == $roleSuperadminId): ?>
                                    <p class="mt-1 text-xs text-gray-500">Department akan diisi otomatis.</p>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($edit_role_id == $roleReceptionistId || $edit_role_id == $roleSuperadminId): ?>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Department tidak diperlukan untuk role ini.</p>
                                <?php else: ?>
                                    <select class="<?php echo e($input); ?>" wire:model.defer="edit_department_id">
                                        <option value="">Pilih department</option>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($d->department_id); ?>"><?php echo e($d->department_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH /home/haelahpx/Documents/GitHub/Frontend-KRB/resources/views/livewire/pages/superadmin/account.blade.php ENDPATH**/ ?>