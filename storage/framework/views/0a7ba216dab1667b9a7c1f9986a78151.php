                                        ...
                                        <div class="flex flex-wrap items-center gap-4 text-[13px] text-gray-600">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($isRoomType): ?>
                                                <span class="<?php echo e($chip); ?>">
                                                    ...
                                                    <span class="font-medium text-gray-700">Room: <?php echo e(optional($row->room)->room_number ?? '—'); ?></span>
                                                </span>
                                            <?php else: ?>
                                                <span class="<?php echo e($chip); ?>">
                                                    <svg class="w-3.5 h-3.5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="w-full max-w-lg bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
                    ...
                    <div class="p-5 space-y-3">
                        <div>
                            ...
                            <textarea rows="4" class="<?php echo e($input); ?> !h-auto resize-none" wire:model.live="rejectReason" placeholder="Contoh: Ruangan dipakai acara lain, jadwal bentrok, dll."></textarea>
...
<?php /**PATH /home/haelahpx/Documents/GitHub/Frontend-KRB/resources/views/livewire/pages/receptionist/bookings-approval.blade.php ENDPATH**/ ?>