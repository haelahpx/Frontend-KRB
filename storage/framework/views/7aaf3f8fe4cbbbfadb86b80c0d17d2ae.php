            ...
            <div>
                ...
                <select wire:model.live="vehicleFilter"
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $label = $v->name ?? $v->plate_number ?? ('#'.$v->vehicle_id); ?>
                        <option value="<?php echo e($v->vehicle_id); ?>"><?php echo e($label); ?></option>
                    ...
                    <div class="flex items-start justify-between gap-4 mb-2">
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base md:text-lg font-semibold text-gray-900 truncate">
                                <?php echo e($b->purpose ? ucfirst($b->purpose) : 'Vehicle Booking'); ?>
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> <?php echo e($b->vehiclebooking_id); ?>
...
<?php endif; ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(!empty($b->destination)): ?>
                                    <span class="text-gray-300">•</span>
                                    <span class="inline-flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium bg-gray-50 text-gray-700 border-2 border-gray-400">
                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                <?php echo e(str_replace('_',' ',ucfirst($b->status))); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-700">
                        <!--[if BLOCK]><![endif]--><?php if(!empty($b->borrower_name)): ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                <span class="font-semibold">Borrower:</span> <?php echo e($b->borrower_name); ?>

                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <!--[if BLOCK]><![endif]--><?php if(!empty($b->purpose_type)): ?>
                            <div class="inline-flex items-center gap-1">
                                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                <span class="font-semibold">Type:</span> <?php echo e(ucfirst($b->purpose_type)); ?>

                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <!--[if BLOCK]><![endif]--><?php if(isset($b->odd_even_area)): ?>
                            <div class="inline-flex items-center gap-1">
                                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                <span class="font-semibold">Odd/Even Area:</span> <?php echo e($b->odd_even_area === 'ya' ? 'Ya' : 'Tidak'); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                <span class="font-semibold">Destination:</span> <?php echo e($b->destination); ?>

                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>

                    <!--[if BLOCK]><![endif]--><?php if(!empty($b->notes)): ?>
...
<?php endif; ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($b->status === 'rejected' && !empty($b->notes)): ?>
...
<?php endif; ?>
                            ...
                            <div class="mt-1 text-sm text-rose-800"><?php echo e($b->notes); ?></div>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                            Before Photo: <?php echo e($beforeC); ?>
...
<?php /**PATH C:\Users\Ochie\OneDrive\Documents\GitHub\Frontend-KRB\resources\views/livewire/pages/user/vehiclestatus.blade.php ENDPATH**/ ?>