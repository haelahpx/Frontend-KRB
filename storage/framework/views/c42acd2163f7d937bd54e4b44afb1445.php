                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="inline-flex items-center bg-white/10 rounded-xl backdrop-blur-sm border border-white/20 text-xs font-medium overflow-hidden">
                            ...
                            <a href="<?php echo e(route('receptionist.bookinghistory') ?? '#'); ?>"
            ...
            <section class="<?php echo e($card); ?> md:col-span-3">
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($activeTab === 'pending'): ?>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <div wire:key="pending-<?php echo e($b->bookingroom_id); ?>"
                                ...
                                <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <div class="flex flex-wrap items-center gap-2 mb-1.5">
                                                <h4 class="font-semibold text-gray-900 text-base truncate">
                                                    <?php echo e($b->meeting_title ?? 'Untitled meeting'); ?>

                                                </h4>
                                                <span class="text-[11px] px-2 py-0.5 rounded-full border <?php echo e($isOnline ? 'border-emerald-300 text-emerald-700 bg-emerald-50' : 'border-blue-300 text-blue-700 bg-blue-50'); ?>">
                                                    <?php echo e($isOnline ? 'Online Meeting' : 'Offline Room'); ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($b->book_reject): ?>
                                                <div class="mt-2 text-xs text-amber-700 bg-amber-50 border border-amber-100 rounded-lg px-2 py-1 inline-block">
                                                    Catatan: <?php echo e($b->book_reject); ?>
                                    ...
                                    <div class="text-right shrink-0 space-y-2">
                                        <div class="flex flex-wrap gap-2 justify-end pt-1.5">
                                            <button type="button"
                                                    wire:click="approve(<?php echo e($b->bookingroom_id); ?>)"
                                            ...
                                            <button type="button"
                                                    wire:click="reject(<?php echo e($b->bookingroom_id); ?>)"
                                                    wire:loading.attr="disabled"
                                        ...
                                        <span class="inline-block text-[11px] px-2 py-0.5 rounded-lg bg-gray-100 text-gray-600 border border-gray-200">
                                            <?php echo e(optional($b->created_at)->timezone('Asia/Jakarta')->format('d M Y H:i')); ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($activeTab === 'ongoing'): ?>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div wire:key="ongoing-<?php echo e($b->bookingroom_id); ?>"
                                 class="px-4 sm:px-6 py-5 hover:bg-gray-50 transition-colors">
                                <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
